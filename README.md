...
つんどけんさくは、手元のPDF蔵書を検索可能にし、必要なページや引用を、人にもAIなどの外部ツールにも渡しやすい形で取り出すためのツールです。
...
Web UIが呼んでいるものと同じHTTP APIを直接使うこともできます。CLI・HTTP APIのどちらも、Web UIの利用者に限らず、スクリプトや他のツールからインデックス作成・検索・エクスポートを呼び出すための手段として使えます。
